...
git clone https://github.com/serg-kas/quick-tiles-segm

cd quick-tiles-segm

Далее рассматриваются варианты запуска приложения:
1. На python c самостоятельным предварительным развертыванием окружения.
2. В самостоятельно собираемом образе docker.
3. В предварительно собранном образе docker (скачивается с нашего ресурса)
4. ?
