...
# dotenv_path = os.path.join(os.path.dirname(__file__), 'cfg.env')     # в текущей папке
dotenv_path = os.path.join(os.path.dirname(__file__), '../cfg.env')  # в папке на уровень выше
